                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            ...
                            <input type="number" class="form-control mb-0" id="uQNT_RFID" name="QNT_RFID" min="0">
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            ...
                            <input type="number" class="form-control mb-0" id="uMediaSmart" name="MediaSmart" min="0">
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <label for="uStampanti" class="mt-2">Stampanti</label>
                            <input type="number" class="form-control mb-0" id="uStampanti" name="Stampanti" min="0">
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6">

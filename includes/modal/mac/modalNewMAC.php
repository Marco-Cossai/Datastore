                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <input type="text" class="form-control mb-0" id="numberMAC" name="Matricola" required>
                        </div>
                        <div class="col-lg-3 col-md-12">
                            <label for="model" class="mt-2">Modello *</label>
                            <select class="form-select py-1 mb-0" id="model" name="Modello" required>
                                <option value=""></option>
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <select class="form-select py-1 mb-0" id="pinpad" name="Pinpad" required>
                                <option value=""></option>
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <select class="form-select py-1 mb-0" id="cpu" name="CPU" required>
                                <option value=""></option>
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <select class="form-select py-1 mb-0" id="printerMAC" name="Stampante" required>
                                <option value=""></option>
                        ...
                        <div class="col-lg-6 col-md-12">
                            ...
                            <select class="form-select py-1 mb-0" id="reader" name="Lettore" required>
                                <option value=""></option>

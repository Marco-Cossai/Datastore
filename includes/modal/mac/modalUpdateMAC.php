                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <input type="text" class="form-control mb-0" id="uNumberMAC" name="Matricola" required>
                        </div>
                        <div class="col-lg-3 col-md-12">
                            <label for="model" class="mt-2">Modello</label>
                            <select class="form-select py-1 mb-0" id="uModel" name="Modello" required>
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <select class="form-select py-1 mb-0" id="uPinpad" name="Pinpad" required>
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <select class="form-select py-1 mb-0" id="uCPU" name="CPU" required>
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <select class="form-select py-1 mb-0" id="uPrinterMAC" name="Stampante" required>
                        ...
                        <div class="col-lg-6 col-md-12">
                            ...
                            <select class="form-select py-1 mb-0" id="uReader" name="Lettore" required>
                                <option value=""></option>

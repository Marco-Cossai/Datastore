<div class="modal fade" id="ModalDeleteMAC" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Cancella MAC</h5>
            ...
            <form action="database/database.php" method="POST">
                <div class="modal-body">
                    ...
                    <input type="hidden" class="form-control" id="dIdMAC" name="Id" readonly>
                    ...
                    <h5 class="text-center text-dark pt-2">Vuoi davvero eliminare questo MAC?</h5>
                </div>

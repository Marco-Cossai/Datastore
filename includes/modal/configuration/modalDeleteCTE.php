<div class="modal fade" id="ModalDeleteCTE" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="database/database.php" method="POST">
                <div class="modal-body">
                    ...
                    <input type="hidden" class="form-control" name="action" value="delete_cte" readonly>
                    <input type="hidden" class="form-control" id="dIdCTE" name="Id" readonly>

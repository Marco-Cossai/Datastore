<!-- Log di richieste di cancellazione -->
<div class="row">
    <div class="col-12">
        <div class="card shadow-sm border">
            <div class="card-body">
                <?php
                    $query = "SELECT * FROM `log` WHERE `Operazione` = 5 ORDER BY `IdLog` DESC";
                    $result = mysqli_query(connDB(),$query) or die(mysqli_error(connDB()));
                    if(mysqli_fetch_array($result)){
                ?>
                <div class="table-responsive">
                    <table id="dtLogRequest" class="table table-sm align-middle text-center py-4">
                        <thead>
                            <tr>
